...
describe('Login Functionality', () => {
    ...
    it('Login Screen should show message from Supabase Error scenarios', async () => {
        const testCases = [
            {
        ...
        for (const testcase of testCases)  {
            mockSignInWithOTP.mockResolvedValue(testcase.error)
            ...
            await waitFor(() => {
                expect(mockSignInWithOTP).toHaveBeenCalledWith(testcase.email, mockNavigation);
                expect(getByText(testcase.error)).toBeTruthy();
            });
